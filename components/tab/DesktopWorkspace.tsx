      ...
      >
        <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden">
          <div
            ...
            className={clsx(
              isDeck
                ? 'flex min-h-0 flex-1 gap-1 overflow-x-auto overflow-y-hidden p-1'
                : isSplit
                  ? 'flex min-h-0 flex-1 min-w-0 flex-row gap-1 overflow-hidden p-1'
                  : 'relative min-h-0 flex-1 overflow-hidden p-1',
            )}
          >
            {tabs.map((tab, index) => {
